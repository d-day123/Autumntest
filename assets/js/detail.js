...
const filterVideos = function (videoList) {
    return videoList.filter(({ type, site }) => (type === 'Trailer' || type === '') && (site === 'YouTube'));
}
    ...
    movieDetail.innerHTML = `
        ...
        <div class="detail-box">
            ...
            <div class="title-wrapper">
                <h3 class="title-large">Movie Servers</h3>
            </div>
            ...
            <div class="slider-list">
                <div class="slider-inner">
                    ...
                    <div class="video-card"><iframe width="600" height="294" src="https://vidsrc.xyz/embed/movie?tmdb=${movieId}" frameborder="0" allowfullscreen="1" title="${name}" class="img-cover" loading="lazy"></iframe></div>

                    
                    <div class="video-card"><iframe width="600" height="294" src=" https://multiembed.mov/?video_id=${movieId}&tmdb=1" frameborder="0" allowfullscreen="1" title="${name}" class="img-cover" loading="lazy"></iframe></div>
